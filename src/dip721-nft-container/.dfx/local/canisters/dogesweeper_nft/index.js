...
import { idlFactory } from './dogesweeper_nft.did.js';
export { idlFactory } from './dogesweeper_nft.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DOGESWEEPER_NFT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dogesweeper_nft.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dogesweeper_nft canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dogesweeper_nft.did.js")._SERVICE>}
 */
export const dogesweeper_nft = createActor(canisterId);
