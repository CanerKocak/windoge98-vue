...
import { idlFactory } from './playing_cards_nft.did.js';
export { idlFactory } from './playing_cards_nft.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PLAYING_CARDS_NFT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./playing_cards_nft.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the playing_cards_nft canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./playing_cards_nft.did.js")._SERVICE>}
 */
export const playing_cards_nft = createActor(canisterId);
